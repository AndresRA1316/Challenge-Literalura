...
//     Método para obtener datos del libro desde la API
    ...
    private void  listarAutoresPorFecha(){
        System.out.println("Escribe el año en que deseas realizar la busqueda: ");
    ...
    private  void  listarLibrosPorIdiomas(){
        ...
        if (!idioma.equals("es") && !idioma.equals("en") && !idioma.equals("fr") && !idioma.equals("pt")) {
            System.out.println("Idioma no válido, intentalo de nuevo");
            return;
        }
        ...
        System.out.println(" lista de libros seleccionados: \n");
        libroIdioma.stream()
                .sorted(Comparator.comparing(Libro::getTitulo))
                .forEach(System.out::println);
    }
